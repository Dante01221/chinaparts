...
export const models: CarModel[] = [
  // BYD
  {
    name: 'Han', slug: 'han', brandSlug: 'byd',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2020–2023', bodyType: 'Седан' },
      { name: 'II поколение', slug: 'gen-2', years: '2023–н.в.', bodyType: 'Седан' },
    ],
  },
  {
    name: 'Tang', slug: 'tang', brandSlug: 'byd',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2018–2021', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2022–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Atto 3', slug: 'atto-3', brandSlug: 'byd',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2021–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Seal', slug: 'seal', brandSlug: 'byd',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2022–н.в.', bodyType: 'Седан' },
    ],
  },
  // Geely
  {
    name: 'Atlas', slug: 'atlas', brandSlug: 'geely',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2016–2019', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2020–2023', bodyType: 'SUV' },
      { name: 'III поколение', slug: 'gen-3', years: '2023–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Coolray', slug: 'coolray', brandSlug: 'geely',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2019–2022', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2022–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Emgrand', slug: 'emgrand', brandSlug: 'geely',
    generations: [
      { name: 'III поколение', slug: 'gen-3', years: '2016–2021', bodyType: 'Седан' },
      { name: 'IV поколение', slug: 'gen-4', years: '2021–н.в.', bodyType: 'Седан' },
    ],
  },
  // Haval
  {
    name: 'H6', slug: 'h6', brandSlug: 'haval',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2011–2014', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2015–2019', bodyType: 'SUV' },
      { name: 'III поколение', slug: 'gen-3', years: '2020–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Jolion', slug: 'jolion', brandSlug: 'haval',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2021–н.в.', bodyType: 'SUV' },
    ],
  },
  // Chery
  {
    name: 'Tiggo 8', slug: 'tiggo-8', brandSlug: 'chery',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2018–2020', bodyType: 'SUV' },
      { name: 'II поколение (Pro)', slug: 'gen-2', years: '2021–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Arrizo 6', slug: 'arrizo-6', brandSlug: 'chery',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2018–2022', bodyType: 'Седан' },
      { name: 'II поколение', slug: 'gen-2', years: '2022–н.в.', bodyType: 'Седан' },
    ],
  },
  // Changan
  {
    name: 'CS75 Plus', slug: 'cs75-plus', brandSlug: 'changan',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2019–2021', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2022–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'Lamore', slug: 'lamore', brandSlug: 'changan',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2022–н.в.', bodyType: 'Хэтчбек' },
    ],
  },
  // GAC
  {
    name: 'GS8', slug: 'gs8', brandSlug: 'gac',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2016–2020', bodyType: 'SUV' },
      { name: 'II поколение', slug: 'gen-2', years: '2021–н.в.', bodyType: 'SUV' },
    ],
  },
  {
    name: 'M8', slug: 'm8', brandSlug: 'gac',
    generations: [
      { name: 'I поколение', slug: 'gen-1', years: '2019–н.в.', bodyType: 'Минивэн' },
    ],
  },
]
...
export const products: Product[] = [
  // BYD Han
  {
    ...
    brand: 'BYD', brandSlug: 'byd',
    model: 'Han', modelSlug: 'han',
    generation: 'I поколение', generationSlug: 'gen-1',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    name: 'Бампер передний BYD Han',
    partNumber: 'BYD-HAN-11101',
    price: 485, currency: 'USD',
    status: 'В наличии', type: 'Оригинал',
    ...
    weight: '8.5 кг', material: 'ABS-пластик',
  },
  {
    id: 'byd-han-grille',
    brand: 'BYD', brandSlug: 'byd',
    ...
    weight: '3.2 кг', material: 'ABS + хром',
  },
  {
    ...
    model: 'Han', modelSlug: 'han',
    generation: 'I поколение', generationSlug: 'gen-1',
    category: 'Освещение', categorySlug: 'lighting',
    ...
    weight: '4.8 кг', material: 'Поликарбонат',
  },
  {
    ...
    weight: '5.2 кг', material: 'Сталь',
  },

  // Geely Atlas
  {
    id: 'geely-atlas-front-bumper',
    brand: 'Geely', brandSlug: 'geely',
    model: 'Atlas', modelSlug: 'atlas',
    generation: 'II поколение', generationSlug: 'gen-2',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    ...
    weight: '9.1 кг', material: 'PP-пластик',
  },
  {
    ...
    weight: '2.8 кг', material: 'ABS + хром',
  },
  {
    ...
    model: 'Atlas', modelSlug: 'atlas',
    generation: 'II поколение', generationSlug: 'gen-2',
    category: 'Тормоза', categorySlug: 'brakes',
    ...
    weight: '1.2 кг', material: 'Керамика',
  },
  {
    id: 'geely-coolray-grille',
    brand: 'Geely', brandSlug: 'geely',
    model: 'Coolray', modelSlug: 'coolray',
    generation: 'I поколение', generationSlug: 'gen-1',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    name: 'Решетка радиатора Geely Coolray (чёрная)',
    partNumber: 'GL-CR-2023-FRO1',
    price: 185, currency: 'USD',
    status: 'В наличии', type: 'Аналог',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAIG59RKxr8KI2sHNBb9UqUt_gW1H9EL3x1XtLfvrlqA3eLJ52mTZ-OAasLomRTyO3TLupb2I9p3rvMskiJaIv2EkAvmx5aFg6_yqH7OpPaR7s1oykoOWutUpXs6zu_TvIAnHMmQQUvHKsCaon4nnfKv4DxASgxR6RUG-qBhXOg3AalIvM-8zlSC4xmItvMDFdy2vT--3ZoVfFPYKfqWM_lqVPy9zKzW7s5fQAsMIj2UyeXAqLDrDf762zAebZtFEKgTOrDzWzc3buW',
    description: 'Решетка радиатора Geely Coolray, матовый чёрный цвет. Подходит 2019-2022.',
    weight: '2.4 кг', material: 'ABS-пластик',
  },

  // Haval H6
  {
    id: 'haval-h6-front-bumper',
    brand: 'Haval', brandSlug: 'haval',
    model: 'H6', modelSlug: 'h6',
    generation: 'III поколение', generationSlug: 'gen-3',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    name: 'Бампер передний Haval H6',
    partNumber: 'HAV-H6-11101',
    price: 440, currency: 'USD',
    status: 'Под заказ', type: 'Оригинал',
    ...
    description: 'Передний бампер Haval H6 2020–2024. Производитель — оригинал Great Wall Motors.',
    weight: '10.3 кг', material: 'PP-пластик',
  },
  {
  ...
  },
  {
    ...
    model: 'Tiggo 8', modelSlug: 'tiggo-8',
    generation: 'II поколение (Pro)', generationSlug: 'gen-2',
    category: 'Двигатель', categorySlug: 'engine',
    ...
    weight: '0.3 кг', material: 'Металл + бумага',
  },

  // Changan CS75 Plus
  {
    id: 'changan-cs75-front-bumper',
    brand: 'Changan', brandSlug: 'changan',
    model: 'CS75 Plus', modelSlug: 'cs75-plus',
    generation: 'II поколение', generationSlug: 'gen-2',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    name: 'Бампер передний Changan CS75 Plus',
    partNumber: 'CHA-CS75-11101',
    price: 410, currency: 'USD',
    status: 'Под заказ', type: 'Оригинал',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBz0mJIpM7-d1uJnIXfPa81T2j4Oudpmq0_Jl5t48p1phBMXcnEkTaF3O-QJgqSIpOeli2amd-l1MQIi5UUc5lnRrxQ2YG1ogmLR0uYT51Rdw3RC0AjC-Ll4RBxXw1hdb2aD_vGZBR5S4d22Yh4zeG6P_mUaQMU3UCs6HGNHNhiBPHpdfS4JldQB55_Xdw6XCLNL7aoMBsl4Umjr2rSWfLQ900LbqOsgm8Nk-JVy8M8DewwAzwbNPfgZK7fEzySLv-q-CWUODZDUE1B',
    description: 'Передний бампер Changan CS75 Plus 2022–2024.',
    weight: '9.5 кг', material: 'PP-пластик',
  },

  // GAC GS8
  {
    id: 'gac-gs8-front-bumper',
    brand: 'GAC', brandSlug: 'gac',
    model: 'GS8', modelSlug: 'gs8',
    generation: 'II поколение', generationSlug: 'gen-2',
    category: 'Кузовные детали', categorySlug: 'kuzov',
    name: 'Бампер передний GAC GS8',
    partNumber: 'GAC-GS8-11101',
    price: 460, currency: 'USD',
    status: 'В наличии', type: 'Оригинал',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBVVE0UazXgKgG-oEDYBhTpRd-CGThGtN_6TAzEydyFg7DVcseLlLLyu2Vh6uBfy3gVmKiDEIl1ENvHy8F05MgJ9kuQ-BWwC06jS0C4S7Sn8BRgSpZhHP0RaiizZv5a6KLUoNgDz0ZvDm2LVx8tPoTW3WUFlnlkAeuUl00q9MifgPhL6Fg5WJAo8sf90oSKd5Rt99XOP6G-jrp30M1rOXtBV9nvPbEj4vpFcrabXEU_B4FZmQFwF4p2x7niHMzBe58-B8pyEEkGHOAT',
    description: 'Оригинальный передний бампер GAC GS8 2021–2024.',
    weight: '10.1 кг', material: 'PP-пластик',
  },
]

export const brands = [
  { name: 'BYD', slug: 'byd', count: products.filter((p) => p.brandSlug === 'byd').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBFHqmm5ytyjr2-q9uwVVNp8cY6nznfb03uwdfaE9fX7x1k5lYlzfQVRrd3X6D68qQBABPdn5xPiE4NDlfiQMmv5-40bOg6Di9k48jaxrwNWYo2uhkMLik7hh1q1a_6Tq62NbcMy1lVxtoFI67TvWxmtlayITbwNnDXH0wIxkjg1b2A5UTtx8rAwSEmEvdMtvyxnyjuQ62aN4AgSf1T2ptoSjgBFVaM4Gnj7AN3BnUSMvxfrgVJMjOLEOXziUt4ndstH--JYzQL9MtM' },
  { name: 'Geely', slug: 'geely', count: products.filter((p) => p.brandSlug === 'geely').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCMwD_0U9_RjvvGSLh8kYjK8BaTbsbvHqsAwKnTgw51ennzpNuzpDtPHeZKq2OBvNI8zlZnSI4mA9wm-dMcPoxQgbk8cGfxcvlzpPcBzKM2CbRB16pSvEZQ13tGOSkfbZeKGAGUvM5l-sYLBS9qETT8ReKXZMUf-CnSieecdGG9h61L9JQaBlCkKWJBT0ZgZVRvKL_St0kjtuj_m63dUXQYrJueD6L06y3x-PyuLAjbMcZ91Jg-exfR8dQjjqQqPq3ohHITVkB4E4BC' },
  { name: 'Haval', slug: 'haval', count: products.filter((p) => p.brandSlug === 'haval').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAr-47_Hq7y3NUAjgyhDyiSqFjgBn0MQlAUmjQFFw5Vt95WLmG5T24zA24ORjE8K1xI2wYBy3tU0HssMdc_Rxndmw__mCCA0p2TsRSW2-mySn5AyWpxw_HJgYweZCYb-spT10bdcMNSW4EnPrD3wBpNZ0G1Z59rIDgj69cJmPSz15Idil0-I6vutk3EdFJakgHzpU4u_y1hwBwaZ0hd5bziYLtzNG9loNMRWtppgJGuBUz01eYJPSJwBNZF5bs7p0T1CgaudTz1rT7K' },
  { name: 'Chery', slug: 'chery', count: products.filter((p) => p.brandSlug === 'chery').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAbQp00igkvjkSvJOlMhYqsLuJsE7pyQiRC_iTGmGRYNepADVEz7zuNplN6eZ34TVh6Cgu96_99x89Kmahs6rj5DyZzB3RoaJ7ysl3Nx__gn8afAOysbuuQcZeROtneHx2CZjpFv1e7tNUfmLWMhG6JqW1dwDvK62MvV5lB0QO7Xv0hVTeV3oxrhE0KpKUCd9r2ILH86jY31QfCRIV7XA3PeUmrY5HOUm28o2yA2351MkekyHbmQB4gcNxnq5lIKAJsVOYYI-dgDWtf' },
  { name: 'Changan', slug: 'changan', count: products.filter((p) => p.brandSlug === 'changan').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuArXzQykUo4wUZsLgWjd-_cLJzAaK5jnsIzXXnrlyLbRiqFPTnLrjKnx0Led4DOAkyLUYkWOv63AtWCz9p3JL7zlH8RHi-eBKzOdjaZmPOSiWqAq2Zi0AFVttkFA81ft498NPHehGtCyPyLVETZG9UmwK403m3Sqzo4NoOQSM2T78Q0jAYJXIxx6uN21mDcyv4jTx8WHRMa12xgHLpUSYYz4t7J8T_eXz5fabNUDKYsC1_PQ41AN8U-6fBdohZ866qvRWWFjlSrJiEs' },
  { name: 'GAC', slug: 'gac', count: products.filter((p) => p.brandSlug === 'gac').length, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCOCl0cLLXzoUXtpj0h1hMEsQDR3r6FlPFIZGRILIF7XTr8oFJiFo_6F_Gigm881-81m930KgbVB5hNG2IPbzRpwkMjMraU1hPTpchNXrYaryNZiaN1286HUj4S5oHqZGa4AjNSU-9YJb3dK2V9xXLr_cgpqVu2C1nC90lP1pVmS2gqldCWSPecXA5Aoz4KfFo6N2BUnyAdH8C7kUQBeOw7_TzlIH8ctmlxO_Tdo6x6pvPoNHLG64J0FOHM1SpWwt9AyC5re0r0TN5u' },
]
